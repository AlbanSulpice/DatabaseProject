        ...
        <header>
            <header id="header">
                ...
                <div id="navgiation-link">
                  <a href="seConnecter.html" id="login-button">Log in</a>
...
#agency-name:hover {
  color: #1aff00;  /* Changement de couleur au survol */
}
...
/* Additional styling for buttons in list and actions */
.btn-link {
  color: #42b983;
  font-weight: bold;
  transition: color 0.3s ease;
